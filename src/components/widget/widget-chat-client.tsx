            ...
            <div className="p-3 bg-white border-t border-slate-200">
                ...
                >
                    <input
                        ...
                        className="flex-1 bg-slate-100 rounded-full px-4 py-2 text-sm text-slate-900 placeholder-zinc-500 focus:outline-none focus:ring-1 focus:ring-indigo-600 border border-slate-200"
                    />
                    <button
                        type="submit"
