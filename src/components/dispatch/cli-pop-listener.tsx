...
export function CliPopListener() {
    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 animate-in slide-in-from-bottom-5 fade-in duration-300">
            <div className="bg-slate-100 border border-slate-200 shadow-xl shadow-indigo-600/10 rounded-xl overflow-hidden min-w-[320px]">
                {/* Header Tape */}
                <div className="bg-indigo-600 h-1.5 w-full animate-pulse" />
                ...
                <div className="p-4 flex flex-col gap-3">
                    ...
                    <div className="flex gap-2 mt-2">
                        <Button
                            onClick={handleBook}
                            className="flex-1 bg-indigo-600 hover:bg-purple-600 text-white font-bold"
                        >
                            Answer & Book
                        </Button>
                        <Button
