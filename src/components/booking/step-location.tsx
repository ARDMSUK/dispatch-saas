...
export function StepLocation({ data, onUpdate, onNext }: Props) {
    ...
    return (
        <div className="space-y-6 h-full flex flex-col">
            <h2 className="text-xl font-bold text-slate-900 mb-2">Where to?</h2>
            ...
            <div className="space-y-4 flex-1">
                ...
                <div className="relative group z-30">
                    ...
                    <LocationInput
                        ...
                        className="w-full bg-slate-100 border border-slate-200 rounded-xl py-4 pl-12 pr-4 text-slate-900 focus:outline-none focus:border-indigo-600/50 transition-all"
                        value={data.pickup}
                ...
                <div className="relative group z-20">
                    <div className="absolute left-3 top-4 text-indigo-600">
                ...
                <div className="grid grid-cols-1 gap-4 pt-4 border-t border-slate-200">
                    <div className="space-y-2">
                        ...
                        <input
                            type="datetime-local"
                            className="w-full bg-slate-100 border border-slate-200 rounded-xl py-3 px-4 text-slate-900 focus:outline-none focus:border-indigo-600/50 [color-scheme:dark]"
                            value={dateStr}
                ...
                <div className="flex items-center gap-3 p-4 rounded-xl border border-slate-200 bg-white/5 hover:bg-slate-200 transition-colors cursor-pointer" onClick={() => onUpdate({ isReturn: !data.isReturn })}>
                    <div className={`h-5 w-5 rounded border flex items-center justify-center ${data.isReturn ? 'bg-indigo-600 border-indigo-600 text-black' : 'border-zinc-600'}`}>
                ...
                {data.isReturn && (
                    <div className="pl-4 border-l-2 border-indigo-600/20 animate-in slide-in-from-top-2">
