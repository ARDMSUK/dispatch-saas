            ...
            <div className="space-y-4 flex-1">
                <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="relative group">
                        <div className="absolute left-3 top-3.5 text-slate-400"><User className="h-5 w-5" /></div>
                        <input
                            type="text"
                    ...
                    {/* Email */}
                    <div className="relative group">
                        <div className="absolute left-3 top-3.5 text-slate-400"><Mail className="h-5 w-5" /></div>
                        <input
                            type="email"
                    ...
                    {/* Phone */}
                    <div className="relative group">
                        <div className="absolute left-3 top-3.5 text-slate-400"><Phone className="h-5 w-5" /></div>
                        <input
                            type="tel"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="text-xs text-slate-400 font-bold mb-1 block">Passengers</label>
                            <input
                                type="number"
                                min="1" max="16"
                        ...
                        <div>
                            <label className="text-xs text-slate-400 font-bold mb-1 block">Luggage</label>
                            <input
                                type="number"
                                min="0" max="10"
                                className="w-full bg-slate-100 border border-slate-200 rounded-xl py-3 px-4 text-slate-900 focus:outline-none focus:border-blue-700/50"
                    ...
                    {/* Flight No */}
                    <div className="relative group">
                        <div className="absolute left-3 top-3.5 text-blue-600"><Plane className="h-5 w-5" /></div>
                        <input
                            type="text"
                            placeholder="Flight Number (Optional)"
                            className="w-full bg-blue-500/10 border border-blue-500/30 rounded-xl py-3.5 pl-12 pr-4 text-slate-900 focus:outline-none focus:border-blue-400/50"
                    ...
                    <div className="relative group h-full">
                        <div className="absolute left-3 top-3.5 text-slate-400"><Clipboard className="h-5 w-5" /></div>
                        <textarea
                    ...
                    {/* Payment Method */}
                    <div className="pt-2">
                        <label className="text-xs text-slate-400 font-bold mb-2 block uppercase">Payment Method</label>
                        <div className="grid grid-cols-2 gap-4">
                            <div
                                onClick={() => onUpdate({ paymentType: 'CASH' })}
                                className={`p-4 rounded-xl border cursor-pointer transition-all flex items-center justify-center gap-2 ${data.paymentType === 'CASH' ? 'bg-emerald-500/10 border-emerald-500 text-emerald-500' : 'bg-slate-100 border-slate-200 text-slate-500 hover:bg-slate-200'}`}
                            >
                            ...
                            <div
                                ...
                                className={`p-4 rounded-xl border cursor-pointer transition-all flex items-center justify-center gap-2 ${data.paymentType === 'CARD' ? 'bg-emerald-500/10 border-emerald-500 text-emerald-500' : 'bg-slate-100 border-slate-200 text-slate-500 hover:bg-slate-200'}`}
                            >
