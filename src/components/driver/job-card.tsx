    ...
    return (
        <div className="relative bg-slate-100 border border-slate-200 rounded-xl overflow-hidden shadow-lg animate-in fade-in slide-in-from-bottom-2">
            ...
            <div className="p-4 space-y-6">
                ...
                {/* Flight Number Badge */}
                {job.flightNumber && (
                    <div className="flex items-center gap-2 px-3 py-1.5 bg-blue-500/10 border border-blue-500/20 rounded text-blue-600 text-xs font-medium w-fit">
            ...
            {showPayment && (
                <div className="absolute inset-0 z-50 bg-zinc-950/95 backdrop-blur-sm flex flex-col items-center justify-center p-6 text-center animate-in fade-in">
                    ...
                    <div className="w-full space-y-3">
                        ...
                        <Button
                            className="w-full h-14 text-lg font-bold bg-blue-600 hover:bg-blue-500 text-slate-900 shadow-lg shadow-blue-900/20"
