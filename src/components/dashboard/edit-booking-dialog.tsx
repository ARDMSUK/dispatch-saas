    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="bg-white border-slate-200 text-slate-900 sm:max-w-[500px]">
                <DialogHeader>
                    <DialogTitle className="text-indigo-600 uppercase tracking-widest text-sm font-bold">Edit Booking #{job?.id}</DialogTitle>
                </DialogHeader>
                ...
                <div className="space-y-4 py-4 max-h-[70vh] overflow-y-auto pr-2 custom-scrollbar">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <input
                                type="datetime-local"
                                className="w-full bg-slate-100 border border-slate-200 rounded-md py-2.5 px-3 text-sm text-slate-900 focus:outline-none focus:border-blue-500/50 [color-scheme:dark]"
                                value={pickupTime}
                ...
                <div className="flex justify-end gap-2 pt-2">
                    ...
                    <Button onClick={handleSave} disabled={loading} className="bg-indigo-600 hover:bg-blue-500 text-black font-bold">
