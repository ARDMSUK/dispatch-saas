        ...
        <div className="py-4 flex flex-col gap-4">
            <div className="bg-card p-4 rounded border border-border grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                ...
                <div className="w-full">
                    ...
                    <Input id="vehicleFileUploadInput" type="file" onChange={e => setFile(e.target.files?.[0] || null)} className="bg-background text-xs pt-2 border-input cursor-pointer text-foreground w-full" />
                </div>
                <div className="w-full">
