    ...
    const getStatusBadge = (status: string) => {
        switch (status) {
            case 'PENDING_AI_REVIEW':
                return <Badge variant="outline" className="text-blue-500 border-blue-400/20 bg-blue-400/10"><Clock className="w-3 h-3 mr-1" /> Pending AI</Badge>;
            case 'ANSWERED':
        ...
        <div className="flex-1 space-y-4 p-8 pt-6 bg-white min-h-screen text-slate-900">
            <div className="flex items-center justify-between space-y-2">
                ...
                <div className="flex items-center space-x-2">
                    <Button asChild className="bg-indigo-600 hover:bg-purple-600 text-black font-semibold">
