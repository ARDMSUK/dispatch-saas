...
export default function BookingsPage() {
    ...
    const getStatusColor = (status: string) => {
        switch (status) {
            ...
            case 'DISPATCHED': return 'bg-indigo-600 hover:bg-purple-600 text-black';
            case 'EN_ROUTE': return 'bg-blue-500 hover:bg-blue-500 text-slate-900';
            case 'ARRIVED': return 'bg-blue-500 hover:bg-indigo-600 text-slate-900';
                                    ...
                                    <td className="p-4">
                                        <div className="flex flex-col h-full justify-between gap-3">
                                            {job.driver ? (
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <div className="h-6 w-6 rounded-full bg-indigo-600/20 text-indigo-600 flex items-center justify-center text-xs font-bold shrink-0">
                                            ...
                                            <div className="flex items-baseline gap-2 mt-auto">
                                                ...
                                                {(() => {
                                                    ...
                                                    if (job.paymentType === 'IN_CAR_TERMINAL') {
                                                        return <Badge className="bg-blue-100 text-indigo-600 hover:bg-blue-200 border-none px-1.5 py-0.5 text-[9px] font-bold rounded-sm uppercase">TERMINAL</Badge>;
                                                    }
