                            ...
                            <>
                                {!qrCodeData ? (
                                    <div className="flex flex-col items-start gap-4">
                                        <div className="flex items-center gap-3 bg-indigo-600/10 border border-indigo-600/20 p-4 rounded-md w-full">
                                            <ShieldAlert className="h-6 w-6 text-blue-500 shrink-0" />
                                            <div>
                                                <h4 className="font-medium text-blue-500">2FA is Not Enabled</h4>
                                                <p className="text-sm text-indigo-600/80">We highly recommend enabling 2FA to protect your account from unauthorized access.</p>
                                            </div>
                                        </div>
                                        <Button
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div>
                                            ...
                                            <code className="bg-white border border-slate-200 p-2 rounded block font-mono text-blue-500 tracking-wider text-center text-lg">
                                                {qrCodeData.secret}
                                            </code>
                                        </div>
                                        ...
                                        <div className="space-y-3 pt-4 border-t border-slate-200">
                                            ...
                                            <div className="flex gap-2">
                                                <Input
                                                    ...
                                                    maxLength={6}
                                                    className="bg-white border-slate-200 text-center text-lg tracking-widest focus:ring-indigo-600 font-mono"
                                                />
                                                <Button
                                                    onClick={confirm2FASetup}
                                                    disabled={verifying || verifyToken.length !== 6}
                                                    className="bg-indigo-600 text-black hover:bg-purple-600 font-bold"
                                                >
                                                    {verifying ? "..." : "Verify"}
                                                </Button>
                                            </div>
