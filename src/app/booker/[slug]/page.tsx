...
import { Loader2, Navigation2, CheckCircle2, MapPin, Flag, Calendar, Car, User, Phone, Plane, MessageSquare, ArrowRight, ArrowLeft } from "lucide-react";
                        ...
                        <AnimatePresence mode="wait">
                            ...
                            {step === 2 && !bookingComplete && (
                                <motion.div
                                    ...
                                    className="space-y-5"
                                >
                                    <div className="relative overflow-hidden p-6 rounded-3xl border border-white/5 text-center shadow-inner mb-6" style={{ backgroundColor: 'rgba(0,0,0,0.4)' }}>
                                        ...
                                        <p className="text-xs text-slate-500 mt-2 font-medium">Pay securely to the driver in-car</p>
                                    </div>
