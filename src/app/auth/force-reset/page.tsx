            ...
            <Card className="w-full max-w-md border-slate-200 bg-white text-slate-900 shadow-xl">
                ...
                <CardContent>
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <Input
                                    ...
                                    {...register("password")}
                                    placeholder="••••••••"
                                    className="bg-slate-100 border-slate-200 text-slate-900 focus:ring-blue-500 focus:border-blue-500 pr-10"
                                />
                                <button
                                    type="button"
                        ...
                        <Button
                            type="submit"
                            className="w-full bg-indigo-600 text-white hover:bg-purple-600 font-bold"
                            disabled={loading}
                        >
