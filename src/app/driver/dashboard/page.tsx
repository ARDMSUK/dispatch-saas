            ...
            <Tabs defaultValue="JOB" className="flex-1 flex flex-col">
                ...
                <div className="border-t border-slate-200 bg-zinc-900/90 backdrop-blur pb-safe">
                    <TabsList className="w-full h-16 bg-transparent p-0 gap-0">
                        <TabsTrigger value="JOB" className="flex-1 h-full flex flex-col items-center justify-center gap-1 rounded-none data-[state=active]:bg-transparent data-[state=active]:text-indigo-600 text-slate-400 border-t-2 border-transparent data-[state=active]:border-indigo-600 transition-colors">
                            <Truck className="h-5 w-5" />
                            <span className="text-[10px] font-medium">Job</span>
                        </TabsTrigger>
                        <TabsTrigger value="HISTORY" className="flex-1 h-full flex flex-col items-center justify-center gap-1 rounded-none data-[state=active]:bg-transparent data-[state=active]:text-indigo-600 text-slate-400 border-t-2 border-transparent data-[state=active]:border-indigo-600 transition-colors">
                            <Clock className="h-5 w-5" />
                            <span className="text-[10px] font-medium">History</span>
                        </TabsTrigger>
                        <TabsTrigger value="PROFILE" className="flex-1 h-full flex flex-col items-center justify-center gap-1 rounded-none data-[state=active]:bg-transparent data-[state=active]:text-indigo-600 text-slate-400 border-t-2 border-transparent data-[state=active]:border-indigo-600 transition-colors">
